...
class AnalyzePage(ctk.CTkFrame):
    ...
    def _export_comprehensive_chart(self, output_path: str):
        ...
        # RECALCULATE fail points using actual spec limits (DB may have
        # incorrect values). A track with no error data is ungraded, never a
        # pass -- see linearity_verdict_from_limits.
