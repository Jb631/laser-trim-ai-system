...
real 8-29 work DB copy (`focus_list_mockup.png`, `focus_chart_no1.png` — kept
under docs/ alongside this spec after implementation, regenerated by the
mockup script if needed).
