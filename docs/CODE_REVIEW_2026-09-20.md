...
| 3 | **Files in which NO CUT was made are stored as flawless trimmed units.** Reported as "an all-zero error column is accepted"; what it really is: when the operator takes a sweep and makes no cut, lasers 1 and 3 still write a `Lin Error` sheet — the blank template, measured = theory to 1e-12. The parser took it for the final sweep. | **1,182 tracks** (6126: 455 · 6607: 224 · 8340: 193 · 8232-1: 163 · 1844205: 92), 1,181 of them linearity PASS, nearly all laser 1 since 2023. In your slice the workbook's REAL sweep is **out of limits in 111 of 130**. 8232-1's laser-1 yield is 42.0 % with them and **39.1 % without**. | **FIXED** `e16808e` + a follow-up in review tonight — they become UNTRIMMED |
